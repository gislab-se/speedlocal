...
ROAD_MEDIUM_AND_COMBINED_EXPECTATIONS = {
    ("roads_medium",): {
        7: {
            300.0: (76.82562795777211, 3183, 32_464.800153824657),
            1000.0: (69.56854532216964, 3227, 29_646.944132938803),
        },
        6: {
            300.0: (55.016181229773466, 973, 22_907.429150913817),
            1000.0: (50.73281091077208, 975, 21_238.995688894654),
        },
        5: {
            300.0: (31.232876712328768, 251, 9_353.053210167978),
            1000.0: (29.520657534246578, 251, 8_582.950414681429),
        },
    },
    ("roads_medium", "roads_large"): {
        7: {
            300.0: (75.01274117218784, 3432, 31_687.381308726330),
            1000.0: (67.43830797233346, 3475, 28_714.965713432139),
        },
        6: {
            300.0: (52.28848821081831, 1032, 21_611.315347293039),
            1000.0: (47.87505316689782, 1034, 19_875.225768060445),
        },
        5: {
            300.0: (27.123287671232877, 266, 7_579.847037049038),
            1000.0: (25.533698630136985, 266, 6_884.650771886860),
        },
    },
}
ROADS_LARGE_R7_AREA_EXPECTATIONS = {
    300.0: (40_488.984781572894, 96.801233478714),
    1000.0: (39_915.411877156715, 95.429932989532),
}
ROADS_LARGE_DOWNSTREAM_EXPECTATIONS = {
    7: {
        300.0: (40_488.984781572894, 96.8838733163451),
        1000.0: (39_915.411877156715, 95.54743356388788),
    },
    6: {
        300.0: (38_253.144122292637, 92.23300970873787),
        1000.0: (37_690.805871436976, 91.01937124364309),
    },
    5: {
        300.0: (32_956.406461690203, 81.91780821917808),
        1000.0: (32_359.768124126273, 80.89917808219177),
    },
}
ROADS_LARGE_APP_ROLLUP_EXPECTATIONS = {
    300.0: {
        7: (96.8838733163451, 13_307, 428),
        6: (97.021590383726, 2_162, 1),
        5: (96.993424657534, 365, 0),
    },
    1000.0: {
        7: (95.54743356388788, 13_301, 434),
        6: (95.716782246879, 2_161, 2),
        5: (95.752602739726, 365, 0),
    },
}
...
POPULATION_EXPECTATIONS = {
    7: {
        100.0: (70.73170731707317, 4_020, 30_409.720538657155),
        500.0: (70.70320705559044, 4_020, 30_399.863685932884),
        1000.0: (63.23414159520412, 4_083, 27_448.136131762622),
        3000.0: (33.07196735844324, 7_588, 14_645.596578610173),
    },
    6: {
        100.0: (47.85020804438280, 1_128, 20_567.420801847358),
        500.0: (47.83465515504408, 1_128, 20_562.351087337258),
        1000.0: (43.15900619940833, 1_136, 18_601.761309792855),
        3000.0: (23.55616618057175, 1_483, 9_910.776568908377),
    },
    5: {
        100.0: (24.38356164383562, 276, 7_220.668025815436),
        500.0: (24.35574779369594, 276, 7_203.775437397472),
        1000.0: (21.60813563563715, 277, 6_203.276636734956),
        3000.0: (14.46149421386573, 302, 3_529.610677240350),
    },
}
NATURE_EXPECTATIONS = {
    7: {
...
def main() -> int:
    ...
    for resolution, expectations in ROADS_LARGE_EXPECTATIONS.items():
        ...
        for road_distance, (
            ...
            if resolution == 7 and frame is not None:
                ...
                report.check(
                    abs(actual_domain_area - TRONDELAG_ELIGIBLE_SURFACE_AREA_KM2)
                    <= 1e-9
                    and abs(actual_area - expected_area) <= 1e-9
    ...
    for road_distance, source_frame in roads_large_r7_frames.items():
        ...
        for resolution, (
            ...
            report.check(
                ...
                and abs(domain_area - TRONDELAG_ELIGIBLE_SURFACE_AREA_KM2)
                <= 1e-9
    ...
    for resolution in DISPLAY_COUNTS:
        ...
        valid = (
            len(downstream) == DISPLAY_COUNTS[resolution]
            and abs(area - TRONDELAG_ELIGIBLE_SURFACE_AREA_KM2) <= 1e-9
    ...
    report.check(
        ...
        and abs(float(exact_area.sum()) - 38_872.46616699324) <= 1e-6
        and abs(
    ...
    report.check(
        ...
        and abs(
            float(exact_solar_area.sum()) - 38_872.46616699324
        )
        <= 1e-6,
