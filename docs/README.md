...
- `FROZEN_V2_REFERENCE.md` — immutable V2 identity and Trøndelag-only behavior
  acceptance scope.
- `DEPLOYMENT.md` — current local and hosted runtime instructions.
- `REPO_HYGIENE.md` — repository boundaries and cleanup rules.
- `archive/` — historical migration plans and prompts; not current
  instructions.

When current documentation conflicts with an archived document,
`GENERAL_PROGRAM_PLAN.md` and `AGENTS.md` take precedence.
